...
import com.example.ShowGameResult.Service.AuthenticationService;
...
import com.example.ShowGameResult.Model.User;
...
public class AuthenticationController {
    ...
    public String login(@RequestParam String username, @RequestParam String password, Model model, HttpServletResponse response) {
        ...
        if (status == HttpStatus.OK) {
            ...
            return "redirect:/showVideoGame/videoGameAnalysis";
